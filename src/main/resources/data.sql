Insert into GLOBAL_SETTINGS (ID,BUSINESS_NAME,BUSINESS_IMAGE,BUSINESS_DAYS,BUSINESS_TIMES,BUSINESS_EMAIL,BUSINESS_PASSWORD,APPOINTMENTS_TIMES_SPLIT) values (1,'Prestige','210223172943-brilliantdentLogo.PNG','1,5','09:00,18:00','info@prestige.it','1234',30) ON CONFLICT DO NOTHING;
...
Insert into  ACCOUNT (ID,USERNAME,PASSWORD,ENABLED,ACTIVE,NAME,SURNAME,AGE,GENDER,EMAIL,PHONE,BIRTHDAY,IMAGE,ADDRESS,CITY,COUNTRY) values (1,'admin.erdit','$2a$10$uaS47hIHlt23gHyjgmo0ruibc.tH2NBXBbiW7p5lJ/pzBLfQWt0we',true,true,'Dervishi','Admin',24,'male','erosdent@hotmail.com',699997000,to_timestamp('17-MAY-21','DD-MON-YY'),'210131141407-27581980_343242869495406_4241852814134870016_n.jpg','Tirane','Tirane','Shqiperi') ON CONFLICT DO NOTHING;
...
Insert into SUBSCRIPTION_HISTORY (ID,ACTIVE,ADDEDDATE,GLOBAL_SETTINGS_ID,SUBSCRIPTION_ID,SUBSCRIPTION_START_DATE,SUBSCRIPTION_END_DATE) values (0,true,TO_TIMESTAMP('18-JUN-21 21:21:44','DD-MON-YY HH24:MI:SS'),1,0,TO_TIMESTAMP('18-JUN-21 21:22:29','DD-MON-YY HH24:MI:SS'),to_timestamp('18-SEP-21 21:21:57','DD-MON-YY HH24:MI:SS')) ON CONFLICT DO NOTHING;
